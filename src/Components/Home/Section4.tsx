      ...
      >
        <Box>
          <Image
            ...
            src="src\assets\home images\section4-img.png"
          ></Image>
        </Box>
          ...
          <Stack direction={"column"} marginTop={"8%"}>
            ...
            <Box width={isMobile ? "100%" : "550px"}>
              ...
              >
                ...
                STUDIO. BARBAROS IS A BIT OF AN ENIGMA, CONSTANTLY ON THE VERGE
                OF DOING SOMETHING WILD AND ADVENTUROUS. HE MOVED TO CYPRUS WITH
                HIS FAMILY WHEN HE WAS NINE YEARS OLD, AND CAPTIVATED BY THE
                MEDITERRANEAN
              </Typography>
              <br />
              <Typography
              ...
              >
                ...
                TALES INTO ENTHUSIASTIC CRAFTSMANSHIP OF THE TRADITIONALLY FAVOR
              </Typography>
            </Box>
          </Stack>
        </Box>
