...
export const BillingFormDesign = ({setUserName,setCompany,setHouseNo,setCity,setProvince,setPhoneNo,setNotes,couponBox,handleCoupon,handleUpload}:BillingForm) => {
  return (
    <div>
 <form>
  ...
  <TextField fullWidth required placeholder='Postcode/ZIP'/>
        ...
        sx={{ backgroundColor:'black',color:'white',fontWeight:'bold',":hover":{
